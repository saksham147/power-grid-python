"""
Django settings for powergrid project.
...
SECRET_KEY = 'django-insecure-6*14o*_is%84vw#2vb9!xx@)n3mx6#58^j6cp1x&8^(h#5^bgr'
...
WSGI_APPLICATION = 'powergrid.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'powergrid'),
